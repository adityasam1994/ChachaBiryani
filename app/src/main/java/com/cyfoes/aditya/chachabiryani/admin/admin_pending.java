...
public class admin_pending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = bottomNavigationView.findViewById(R.id.pending);
        view.performClick();
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.accepted:
                        startActivity(new Intent(admin_pending.this, admin_home.class));
                        break;

                    case R.id.completed:
                        startActivity(new Intent(admin_pending.this, admin_completed.class));
                        break;

                    case R.id.menu:
                        startActivity(new Intent(admin_pending.this, menu.class));
                        break;

                    case R.id.shop:
                        startActivity(new Intent(admin_pending.this, shop.class));
                        break;
                }
                return true;
            }
                    ...
                    for (final DataSnapshot dorders : dusers.getChildren()) {
                        if (dorders.hasChild("order_status") && dorders.hasChild("address") && dorders.hasChild("latitude")
                            ...
                            if (dorders.child("order_status").getValue().toString().equals("pending")) {
                                count++;
                                LayoutInflater inflater = LayoutInflater.from(admin_pending.this);
                                ...
                                lay.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        final Dialog dialog = new Dialog(admin_pending.this);
                                        ...
                                        accept.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                dialog.dismiss();
                                                Toast.makeText(admin_pending.this, "Order accepted!", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                        ...
                                        reject.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                dialog.dismiss();
                                                Toast.makeText(admin_pending.this, "Order rejected!", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                });
